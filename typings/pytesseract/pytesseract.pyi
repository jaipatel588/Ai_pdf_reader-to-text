...
def run_tesseract(input_filename, output_filename_base, extension, lang, config=..., nice=..., timeout=...): # -> None:
    ...

def run_and_get_multiple_output(image, extensions: List[str], lang: Optional[str] = ..., nice: int = ..., timeout: int = ..., return_bytes: bool = ...): # -> list[bytes | str]:
    ...

def run_and_get_output(image, extension=..., lang=..., config=..., nice=..., timeout=..., return_bytes=...): # -> bytes | str:
    ...
...
def image_to_string(image, lang=..., config=..., nice=..., output_type=..., timeout=...):
    """
    Returns the result of a Tesseract OCR run on the provided image to string
    """
    ...

def image_to_pdf_or_hocr(image, lang=..., config=..., nice=..., extension=..., timeout=...): # -> bytes | str:
    """
    Returns the result of a Tesseract OCR run on the provided image to pdf/hocr
    """
    ...

def image_to_alto_xml(image, lang=..., config=..., nice=..., timeout=...): # -> bytes | str:
    """
...
def image_to_data(image, lang=..., config=..., nice=..., output_type=..., timeout=..., pandas_config=...):
    """
